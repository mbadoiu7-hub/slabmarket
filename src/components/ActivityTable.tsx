      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {activities.map((activity) => {
            ...
            const platConfig =
              platformConfig[activity.platform] || {
            ...
            return (
              ...
              >
                <td className="px-4 py-3">
                  <span
                    className={`px-2 py-1 rounded text-xs font-bold ${activityBadge.bg} ${activityBadge.textColor}`}
                  >
                    {activityBadge.label}
                  </span>
                </td>
                <td className="px-4 py-3">
                  <span
                    className={`px-2 py-1 rounded text-xs font-bold ${platConfig.bg} ${platConfig.textColor}`}
                  >
                    {platConfig.tag}
                  </span>
                </td>
